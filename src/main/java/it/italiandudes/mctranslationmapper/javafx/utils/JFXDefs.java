package it.italiandudes.mctranslationmapper.javafx.utils;
...
public final class JFXDefs {
    ...
    public static final class AppInfo {
        public static final String NAME = "MCTranslationMapper";
    ...
    public static final class Resources {
        ...
        public static final class FXML {
            ...
            public static final String FXML_TRANSLATION_MAPPER = FXML_DIR + "SceneTranslationMapper.fxml";
        }
